angular.module(APP_ID).controller('questionnaireController', ['$stateParams', '$state', 'alert', '$q', 'spinner', 'workerService', 'authService', 'reviewService',
    function($stateParams, $state, alert, $q, spinner, workerService, authService, reviewService) {
        ...
        function _loadData() {
            ...
            reviewService.fetchEntry($stateParams.token, _getLoggedUserId())
